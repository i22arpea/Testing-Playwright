...
public class CalcularPreciosAsignaturaPCEOIgualesTest {
...
//    private DatosAcademicosSessionMBean datosAcademicosSessionMBean;
    ...
    void test()
        ...
        Titulacion titu2 = TitulacionMother.create(260, "RRII", true);
        TitulacionDoble titulacionDoble = TitulacionDobleMother.create(261, titu1, titu2);
        ...
        titulacion.setNombre("ADE + RRII");
        titulacion.setPreciosPceoDiferentes(false);
        ...
        BigDecimal importeCredito2Titu = BigDecimal.valueOf(130);

        BigDecimal importeCreditoTitu1 = BigDecimal.valueOf(120);
        BigDecimal importeCredito2Titu1 = BigDecimal.valueOf(140);

        BigDecimal importeCreditoTitu2 = BigDecimal.valueOf(110);
        BigDecimal importeCredito2Titu2 = BigDecimal.valueOf(150);
        ...
        BigDecimal resultadoPrecioAsignatura1 = BigDecimal.valueOf(780);
        BigDecimal resultadoPrecioAsignatura2 = BigDecimal.valueOf(780);
        ...
        Assertions.assertEquals(resultadoPrecioAsignatura1.doubleValue(), resultadoPrecioAsignatura2.doubleValue(),
                CalcularPreciosTestUtils._TOLERANCIA);
        Assertions.assertFalse(pmatAlumnoInscripcion.isPreciosPorPce());
